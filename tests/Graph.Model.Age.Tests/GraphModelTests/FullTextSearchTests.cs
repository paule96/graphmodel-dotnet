...
/// See <see href="docs/age-fulltext-search-limitations.md"/> for details.
/// </summary>
    ...
    IFullTextSearchTests
{
    ...
    [Fact(Skip = "AGE does not support full-text search within Cypher. See docs/age-fulltext-search-limitations.md")]
